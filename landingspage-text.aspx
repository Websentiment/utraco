<%@ Page Title="" Language="VB" MasterPageFile="~/page.master" AutoEventWireup="false" CodeFile="landingspage-text.aspx.vb" Inherits="_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <section class="landing">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 offset-sm-1">
                        <div class="ml-form-embed"
                            data-account="1698512:q9p1p9q3t2"
                            data-form="1552156:y3d9v4">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="text" runat="server" visible="false">
            <div class="container">
